...
@section('container')
    ...
    @if ($post->count())
        <div class="card mb-3">
            ...
            <h6>By : <a href="/post?author={{ $post[0]->author->username }}">{{ $post[0]->author->name }}</a> | category <a href="/post?category={{ $post[0]->category->slug}}" class="text-decoration-none">{{ $post[0]->category->name}}</a>
    ...
    <div class="cointainer">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="position-absolute px-3 py-2" style="background-color: rgba(0, 0, 0, 0.5)"><a href="/post?category={{ $posting->category->slug }}" class="text-white">{{ $posting->category->name }}</a></div>
                    ...
                    <div class="card-body">
                      ...
                      <h6>By : <a href="/post?author={{ $posting->author->username }}">{{ $posting->author->name }}</a>

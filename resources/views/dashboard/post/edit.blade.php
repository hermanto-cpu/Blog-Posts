...
<div class="col-lg-8">
    <form method="post" action="/dashboard/post/{{ $posting->slug }}">
        @method('put')
        @csrf
        <div class="mb-3">
    ...
    @enderror
        ...
        <div class="mb-3">
            ...
            @if ($posting->image)
            <img src="{{ asset('storage/' . $posting->image) }}" class="img-preview img-fluid mb-3 col-sm-6 d-block">   
            @else
        ...
        @enderror
            <input id="body" type="body" name="body" value="{{ old('body', $posting->body) }}">
